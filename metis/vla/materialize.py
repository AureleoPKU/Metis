...
from metis.vla.datasets import EpisodicRLDSDataset, RLDSBatchTransform, RLDSBatchTransformLatentAction, RLDSBatchTransformCoTLatentAction,  RLDSDataset
...
def get_cot_latent_vla_dataset_and_collator(
    ...
    batch_transform = RLDSBatchTransformCoTLatentAction(
        action_tokenizer=latent_action_tokenizer,
        base_tokenizer=tokenizer,
        image_transform=image_transform,
        image_transform_lam=image_transform_lam,
    ...
    collator = PaddedCollatorForActionPrediction(
        tokenizer.model_max_length, tokenizer.pad_token_id, padding_side=padding_side, num_padding=0
    )
