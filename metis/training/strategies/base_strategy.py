...
from metis.training.metrics import Metrics, VLAMetrics
from metis.util import check_bloat16_supported
from metis.util.batching_utils import SplitModalitySampler
from metis.util.data_utils import PaddedCollatorForActionPrediction, PaddedCollatorForLanguageModeling
    ...
    def run_vla_training(
        ...
        with tqdm(
            ...
            for batch in dataloader:
                ...
                action_preds = vla_output.logits[:, self.vla.vlm.vision_backbone.num_patches : -1].argmax(dim=2)
