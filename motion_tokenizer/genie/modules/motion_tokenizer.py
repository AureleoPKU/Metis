...
from motion_tokenizer.genie.modules.blocks import SpatioTemporalTransformer, SpatioTransformer, VectorQuantizer

from motion_tokenizer.genie.modules.hand_encoder.hf_pose import HF_Pose
from motion_tokenizer.genie.modules.hand_encoder.pose_decoder import MicroactionDecoderTCN
from motion_tokenizer.genie.modules.rq import ResidualVQ
...
class RQ_HandLatentActionModel(nn.Module):
    ...
    def __init__(
        ...
        self.vq_hand = ResidualVQ(
            dim=latent_dim,
            num_quantizers=2,           # 3
            codebook_size=512,         # codebook
            shared_codebook=True,        # codebook
            kmeans_init=True,
            kmeans_iters=50,
        ...
        self.action_encoder = HF_Pose(microaction_window_size=8, num_joints=5,
                    embedding_dim_final=768, use_2d_pose=False, dropout=0.0, # dropout
        ...
        # enc_out: (B, M, L, D),  L=J*E, D=embedding_dim
    ...
    def vq_encode(self, videos: Tensor, actions: Tensor) -> Dict:
        ...
        # print('indices_video:',indices_video)

        # #hand token
        z_action = action_feature # B 2 10 768
        ...
        # print('indices_hand:',indices_hand)
